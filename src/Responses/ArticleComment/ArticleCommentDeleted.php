...
class ArticleCommentDeleted extends AbstractResponse
{
    ...
    {
        try{
            return $this->twig->render('digital-blog/comments/comment-deleted.html.twig', $this->buildViewParameters());
        }catch (LoaderError $loaderError){
            return $this->twig->render('@DigitalBlog/back/comments/comment-deleted.html.twig', $this->buildViewParameters());
        }
    }
}