...
class RedirectToNotAuthenticatedResponse extends AbstractResponse
{
    ...
    {
        try{
            return $this->twig->render('digital-blog/auth/redirect-to-login.html.twig', $this->buildViewParameters());
        }catch (LoaderError $loaderError){
            return $this->twig->render('@DigitalBlog/auth/redirect-to-login.html.twig', $this->buildViewParameters());
        }
    }
}