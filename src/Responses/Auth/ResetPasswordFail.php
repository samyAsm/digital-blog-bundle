...
class ResetPasswordFail extends AbstractBadRequestResponse
{
    ...
    {
        try {
            return $this->twig->render('digital-blog/auth/reset-password-fail.html.twig', $this->buildViewParameters());
        } catch (LoaderError $loaderError) {
            return $this->twig->render('@DigitalBlog/auth/reset-password-fail.html.twig', $this->buildViewParameters());
        }
    }
}