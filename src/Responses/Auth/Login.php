...
class Login extends AbstractResponse
{
    ...
    {
        try{
            return $this->twig->render('digital-blog/auth/login.html.twig', $this->buildViewParameters());
        }catch (LoaderError $loaderError){
            return $this->twig->render('@DigitalBlog/auth/login.html.twig', $this->buildViewParameters());
        }
    }
}